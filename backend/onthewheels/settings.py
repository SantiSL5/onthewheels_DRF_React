"""
Django settings for onthewheels project.
...
SECRET_KEY = 'django-insecurelocal-&syyk#ntb_5txgb_ib%rv6oul0h_e*s0wkiygcr0=@vz(z9&yt'
...
WSGI_APPLICATION = 'onthewheels.wsgi.application'
