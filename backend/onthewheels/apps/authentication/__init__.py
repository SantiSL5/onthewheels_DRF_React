...
class AuthenticationAppConfig(AppConfig):
    name = 'onthewheels.apps.authentication'
    label = 'authentication'
    verbose_name = 'Authentication'

    def ready(self):
        import onthewheels.apps.authentication.signals
...
default_app_config = 'onthewheels.apps.authentication.AuthenticationAppConfig'
